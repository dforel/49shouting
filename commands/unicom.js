      ...
      if (hasTasks) {
        await scheduler.execTask(command, account.tasks).catch(err => console.error("unicom任务:", err)).finally(() => {
          ...
          if (Object.prototype.toString.call(scheduler.taskJson.rewards) === '[object Object]') {
            ...
            https.get("https://sc.ftqq.com/SCU68781Tee5b77950beb32c5278986f92a9664cd5df47e99e2d52.send?text=今日获得奖品信息统计"+dateFormat("YYYY-mm-dd HH:MM", new Date())+"&desp="+content,function(data){
                var str="";
